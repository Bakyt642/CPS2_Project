...
public class MqttHelperB {
    public MqttAndroidClient mqttAndroidClient;

    final String serverUri = "tcp://m15.cloudmqtt.com:14558";

    final String clientId = "ExampleAndroidClient";
    final String topicworker = "Android/Workbench2/Worker";
    ...
    public MqttHelperB(Context context){
    ...
    private void Worker1Topic() {
        try {
            mqttAndroidClient.subscribe(topicworker, 0, null, new IMqttActionListener() {
                @Override
                public void onSuccess(IMqttToken asyncActionToken) {
